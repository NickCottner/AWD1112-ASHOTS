...
public class rvEmployeeAdapter extends RecyclerView.Adapter<rvEmployeeAdapter.MyViewHolder> {
    ...
    Context context;
    int[] addEmployeeImages;
    //  Constructor


    public rvEmployeeAdapter(List<EmployeeModel> employeeList, Context context, int[] addEmployeeImages) {
        this.employeeList = employeeList;
        this.context = context;
        this.addEmployeeImages = addEmployeeImages;
    }
